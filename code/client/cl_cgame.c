...
/**
 * Return the chat color of the given skin
 * 
 * @author ClearSkies
 * @param team The team the client is in
 * @param skin The skin the client is using
 * @return The chat color of the given skin
 */
int CL_SkinToChatColour(int team, int skin) {
